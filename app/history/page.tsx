      ...
      <header className="border-b border-black bg-yellow-200">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="flex gap-3 items-center">
            ...
            <Link className="px-4 py-2 border border-black rounded-lg bg-yellow-500 font-bold" href="/history">History</Link>
            <Link className="px-4 py-2 border border-black rounded-lg bg-yellow-300 hover:bg-yellow-400 transition" href="/progress">Progress</Link>
      ...
      <main className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="bg-yellow-100 border border-black rounded-xl p-6">
          {loading ? (
            ...
            <div className="border border-dashed border-black rounded-lg p-6 text-center">No results yet.</div>
          ) : (
            <div className="space-y-3">
              {safeResults.map((r) => (
                <div
                  key={r.id}
                  className="bg-yellow-50 border border-black rounded-lg p-4 flex items-center justify-between"
                >
                  <div>
                    <p className="font-bold">Score: {r.score}%</p>
