    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div>
            <h2 className="text-2xl font-bold mb-1">
              {role === "teacher" ? "My Questions" : "Questions"}
            </h2>
            <p className="text-sm">
              Pick a quiz, then add, edit, or delete questions.
            </p>
          </div>
      ...
      <div className="bg-yellow-100 border border-black rounded-2xl p-6">
        ...
        <div className="text-xs opacity-80 mt-4">
          If insert, update, or delete fails with a permissions error, Supabase RLS or policies are blocking it.
        </div>
      </div>
    </div>
  );
